...
namespace BLL.Local.Services
{
    ...
    public class TestStudentService
    {
        ...
        public void Setup()
        {
            ...
            mock.Setup(lp => lp.Student).Returns(new StubStudentRepository());
            mock.Setup(lp => lp.Set<StudentDto>()).Returns(new StubStudentRepository());
            mock.Setup(lp => lp.Set<StudentDto, int>()).Returns(new StubStudentRepository());
