...
namespace BLL.Local.Services
{
    ...
    public class TestAcademicPerformanceService
    {
        ...
        public void Setup()
        {
            ...
            mock.Setup(lp => lp.AcademicPerformance).Returns(new StubAcademicPerformanceRepository());
            mock.Setup(lp => lp.Set<AcademicPerformanceDto>()).Returns(new StubAcademicPerformanceRepository());
            mock.Setup(lp => lp.Set<AcademicPerformanceDto, int>()).Returns(new StubAcademicPerformanceRepository());
