...
namespace BLL.Local.Services
{
    ...
    public class TestSexService
    {
        ...
        public void Setup()
        {
            ...
            mock.Setup(lp => lp.Sex).Returns(new StubSexRepository());
            mock.Setup(lp => lp.Set<SexDto>()).Returns(new StubSexRepository());
            mock.Setup(lp => lp.Set<SexDto, int>()).Returns(new StubSexRepository());
